/*
  ...
  1. Organizations
    - Creates Verplex and TechCorp demo organizations
  
  2. User Profiles
    - Creates demo user profiles for different roles
    - Links users to organizations
  
  3. Projects and Tasks
    - Sample NLP and Analytics projects
    - Associated tasks with different statuses
  
  4. Files and Notifications
    - Sample file metadata
    - Demo notifications for users
  
  5. Financial Records
    - Sample invoices and expenses
  
  6. Knowledge Base
    - Sample articles and documentation
*/
...
INSERT INTO organizations (id, name, slug, description, industry, size_category, created_at, updated_at) VALUES
  ('aaaaaaaa-bbbb-cccc-dddd-111111111111', 'Verplex', 'verplex', 'Digital Operating System Company', 'Technology', 'startup', now(), now()),
  ('bbbbbbbb-cccc-dddd-eeee-222222222222', 'TechCorp', 'techcorp', 'Technology Corporation', 'Technology', 'medium', now(), now())
